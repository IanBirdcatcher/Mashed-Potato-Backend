module.exports = (app) => {
  ...
  const { authenticate, checkAdmin } = require("../authorization/authorization.js");
  ...
  //admin stuff
  router.put("/id", [authenticate, checkAdmin], user.updateAdmin);
  router.post("/", [authenticate, checkAdmin], user.addAdmin);
